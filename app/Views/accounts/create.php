                    ...
                    <form action="/account" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($validation->hasError('customer_name')) ?  'is-invalid' : ''  ?>" id="customer_name" name="customer_name" value="<?= old('customer_name') ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($validation->hasError('industry')) ?  'is-invalid' : ''  ?>" id="industry" name="industry" value="<?= old('industry') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($validation->hasError('branch')) ?  'is-invalid' : ''  ?>" id="branch" name="branch" value="<?= old('branch') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($validation->hasError('pic_name')) ?  'is-invalid' : ''  ?>" id="pic_name" name="pic_name" value="<?= old('pic_name') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= ($validation->hasError('branch')) ?  'is-invalid' : ''  ?>" id="sales_name" name="sales_name" value="<?= old('sales_name') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control <?= ($validation->hasError('branch')) ?  'is-invalid' : ''  ?>" id="sales_phone" name="sales_phone" value="<?= old('sales_phone') ?>">
